...
export default function RootLayout() {
  ...
  // ADR-V7-07: Gate Manus runtime to web preview container only.
  // initManusRuntime() sends postMessage to parent window — a Manus dev-preview concern.
  // On Android native it's a no-op but the DEBUG logging still fires. Removed from prod path.
  useEffect(() => {
    if (Platform.OS === "web") {
      initManusRuntime();
    }
