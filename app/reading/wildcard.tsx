  ...
  useEffect(() => {
    const timeout = setTimeout(() => {
      Animated.timing(flipAnim, {
        toValue: 180,
        duration: 800,  // v7: DURATION.ritual — more weight to the reveal
        easing: Easing.bezier(0.16, 1, 0.3, 1), // EASING.reveal
  ...
  return (
    <Pressable
      ...
      style={({ pressed }) => [
        styles.cardShell,
        {
          // v7: non-selected cards fade to 45% when a selection is made
        opacity: isSelected ? 1 : pressed ? 0.88 : 1,
          transform: [{ scale: isSelected ? 1.025 : pressed ? 0.97 : 1 }],
        },
      ]}
    >
        ...
        <Animated.View
          style={[
            ...
            styles.cardBack,
            {
              ...
              // v7: selected cards show stronger glow border
